    ...
    return (
      <main className="mx-auto min-h-[calc(100vh-4rem)] max-w-2xl px-6 py-16">
        <div className="rounded-2xl border border-red-200 bg-red-50/50 p-8 text-center">
          ...
          <Link
            href="/dashboard"
            className="mt-6 inline-flex items-center gap-2 rounded-lg bg-neutral-900 px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-neutral-700"
          >
            Back to Dashboard
          </Link>
        </div>
          ...
          <div className="relative mb-10 h-36 w-36">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              {isPending ? (
                ...
                <svg className="h-8 w-8 animate-spin text-neutral-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <main className="mx-auto min-h-[calc(100vh-4rem)] max-w-2xl px-6 py-16">
        <div className="rounded-2xl border border-red-200 bg-red-50/50 p-8 text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/upload"
              className="inline-flex items-center gap-2 rounded-lg bg-neutral-900 px-5 py-2.5 text-sm font-medium text-white transition-all hover:bg-neutral-700"
            >
              Try Again
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 rounded-lg border border-neutral-200 bg-white px-5 py-2.5 text-sm font-medium text-neutral-700 transition-all hover:border-neutral-300 hover:bg-neutral-50"
            >
              Back to Dashboard
            </Link>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          {report.video?.cosUrl && (
            <a
              ...
              download
              className="inline-flex items-center gap-2 rounded-lg bg-neutral-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-neutral-700"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
